 ...
 *
 * The followings are the available columns in table 'e_region':
...
class ERegion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('region_code, region_name, is_additional', 'required'),
			array('region_code, is_additional', 'numerical', 'integerOnly'=>true),
			array('region_name', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('region_id, region_code, region_name, is_additional', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ERegion the static model class
	 */
