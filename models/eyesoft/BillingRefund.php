...
/**
 * This is the model class for table "billing_refund".
 *
 * The followings are the available columns in table 'billing_refund':
 * @property string $id
 ...
 */
class BillingRefund extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, billno, amount, doctor, comment, archived, refundby, refunddate', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return BillingRefund the static model class
	 */
